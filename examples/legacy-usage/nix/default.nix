...
let
  ...
  nixops = nixops-flake-repo.legacyPackages.${currentSystem}.nixops_2_0-2021-01-unstable;

  # Impure build with customizable plugins
  # See the main README.md for a list of available plugins to use
  customPlugins = [ "aws" ];
  nixops-custom = let
    nixops-impure = nixops-flake-repo.outputs.impure.${currentSystem}.nixops_2_0-2021-01-unstable customPlugins;
