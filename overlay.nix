...
final: prev: {
  ...
  nixops_2_0pre-2020-07-unstable = pkgs.callPackage ./pkgs/nixops_2-2020-07-unstable.nix { inherit self system pkgs; };
  nixops_2_0pre-2021-01-unstable = pkgs.callPackage ./pkgs/nixops_2-2021-01-unstable.nix { inherit self system pkgs; };
}
